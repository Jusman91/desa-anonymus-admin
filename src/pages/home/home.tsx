	...
	return (
		<>
			<section className='w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 auto-rows-[minmax(100px,auto)] md:auto-rows-[minmax(160px,auto)] gap-2'>
				<div className='bg-bkg-container rounded-md row-span-2 p-2 shadow-md'>
					<NewProduct />
				</div>
				<div className='bg-bkg-container rounded-md p-2 shadow-md'>
					<ProductStatistics />
				</div>
				<div className='bg-bkg-container rounded-md p-2 shadow-md'>
					<ArticleStatistics />
				...
				<div className='bg-bkg-container rounded-md p-2 shadow-md grid place-items-center'>
					<small className='text-orange-600 font-bold tracking-widest'>
						**Coming soon**
					</small>
				</div>
				<div className='bg-bkg-container rounded-md md:col-span-2 row-span-2 p-2 shadow-md grid place-items-center'>
